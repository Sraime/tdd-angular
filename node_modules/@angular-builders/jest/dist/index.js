...
function runJest(options, context) {
    ...
    function buildArgv() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const configuration = new jest_configuration_builder_1.JestConfigurationBuilder(new default_config_resolver_1.DefaultConfigResolver(options.tsConfig), new custom_config_resolver_1.CustomConfigResolver(context.logger.createChild('Jest runner'))).buildConfiguration(projectRoot, workspaceRoot, options.configPath);
